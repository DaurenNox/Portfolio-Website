    ...
    <div className='container mx-auto'>
      <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
        ...
        className='flex-1'>
          ...
          <p className='mb-6'>    
            Developers, also known as software developers     
</p>
        {/* stats */}
        <div className='flex gap-x-6 lg:gap-x-10 mb-12'>
          <div>
            <div className='text-[40px] font-tertiary text-brown mb-2 mt-10'>
              {
          ...
          <div>
            <div className='text-[40px] font-tertiary text-while mb-2 mt-10'>
              {
